...
KEY_REGEX='^net\.core\.default_qdisc|^net\.core\.rmem_max|^net\.core\.wmem_max|^net\.core\.rmem_default|^net\.core\.wmem_default|^net\.ipv4\.tcp_rmem|^net\.ipv4\.tcp_wmem|^net\.ipv4\.tcp_congestion_control'
